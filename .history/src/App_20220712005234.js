  ...
  return (
    <div className="mainContainer" style={{ background: "url('background.jpg')", backgroundColor: '#09BEDE' }}>
      ...
      <div className="dataContainer">
        ...
        <div>
          <img src={`https://avatars.dicebear.com/api/adventurer/${0x6752e6D532dB26bD2E5074113a06B413A789CC74}.svg`} style={{borderColor: "white", borderWidth: "0.5", padding: "5px", border: "solid", background: "#0483AD", borderRadius: "50px", boxShadow: "0 4px 30px rgba(0, 0, 0, 0.1)", backdropFilter: "blur(6.5px)", WebkitBackdropFilter: "blur(6.5px)"}} width={50} height={50} />
