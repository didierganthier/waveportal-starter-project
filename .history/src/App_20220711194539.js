  ...
  return (
    <div className="mainContainer" style={{ background: "url('background.jpg')" }}>
      ...
      <div className="dataContainer">
        ...
        <input type="text" maxLength={200} minLength={10} onChange={(e) => setMessage(e.target.value)} onSubmit={wave} placeholder="Enter a message, it will be stored on the blockchain forever 😉"  style={{ padding: "16px", borderRadius: "8px", outlineColor: "#00000F", borderWidth: "1px" , marginTop: "16px", marginBottom: "16px"}}/>
