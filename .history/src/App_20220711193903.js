    ...
    <div className="mainContainer" style={{ background: "url('background.jpg')" }}>
      ...
      <div className="dataContainer">
        ...
        {allWaves.map((wave, index) => {
          return (
            <div key={index} style={{ background: "rgba(45, 209, 239, 0.43)",  borderRadius: "8px", boxShadow: "0 4px 30px rgba(0, 0, 0, 0.1)" , backdropFilter: "blur(6.5px)", WebkitBackdropFilter: "blur(6.5px)",border: "1px solid rgba(45, 209, 239, 0.51)", marginTop: "10px", marginBottom: "10px", padding: "12px" }}>
